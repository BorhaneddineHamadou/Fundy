...
export default function ProfileThree({navigation}) {  
    const goToExploring = () => {
    ...
    <SafeAreaView style={styles.getstarted}>
      <ImageBackground source={require('../../assets/profile.png')} style={styles.illustration} >
        ...
        <View style={styles.button}>
            <TouchableOpacity style={[styles.btn_button]} onPress={goToProfile}>
        ...
        <View style={styles.content}>
            <Image style={{width: 320, height:100}} source={require('../../assets/tab2.png')} />
        </View>
