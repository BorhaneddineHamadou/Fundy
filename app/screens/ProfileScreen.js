  ...
  return (
    <SafeAreaView style={styles.getstarted}>
      <ImageBackground source={require('../../assets/profile.png')} style={styles.illustration} >
        ...
        {/* Event */}
        <TouchableOpacity onPress={goToConnections} style={{position: 'absolute', opacity:0 , width: '40%', height: 40, top: 190, right: 66}}></TouchableOpacity>
        
        <View style={styles.button}>
            <TouchableOpacity style={[styles.btn_button, styles.active]}>
                <Text style={{textAlign: 'center', fontSize: 20}}>Achivments</Text>
            </TouchableOpacity> 
            <TouchableOpacity style={styles.btn_button} onPress={goToProfileThree}>
                 <Text style={{textAlign: 'center', fontSize: 20}}>Intersts</Text>
            </TouchableOpacity> 
            <TouchableOpacity style={styles.btn_button} onPress={goToProfileTwo}>
                 <Text style={{textAlign: 'center', fontSize: 20}}>Events</Text>
            </TouchableOpacity> 
        </View>
        <View style={styles.content}>
            <Text style={{fontSize: 17}}>&#9755; HackIn 2022 winner</Text>
            <Text style={{fontSize: 17}}>&#9755; HackIn 2022 winner</Text>
            <Text style={{fontSize: 17}}>&#9755; HackIn 2022 winner</Text>
            <Text style={{fontSize: 17}}>&#9755; HackIn 2022 winner</Text>
        </View>
